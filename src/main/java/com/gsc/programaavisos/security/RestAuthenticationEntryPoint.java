...
import com.gsc.programaavisos.exceptions.ApiError;
...
public class RestAuthenticationEntryPoint implements AuthenticationEntryPoint {
   ...
   public void commence(HttpServletRequest request, HttpServletResponse response, AuthenticationException ex) throws IOException, ServletException {
      ...
      ApiError apiError = new ApiError(ApiErrorConstants.NO_PERMISSIONS, HttpStatus.UNAUTHORIZED, ex.getMessage(), null, ex.getCause() ==null?ex.getMessage():ex.getCause().getMessage());
