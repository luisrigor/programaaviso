...
import com.gsc.programaavisos.model.crm.entity.ClaimDetail;
import com.gsc.programaavisos.model.crm.entity.ProgramaAvisos;
import com.gsc.programaavisos.model.crm.entity.Quarantine;
...
public class PAServiceImpl implements PAService {
            ...
            if(id > 0) {
               ProgramaAvisos oPA =  dataPA(pa);
                ...
                if(isToSendSchedule!=null && isToSendSchedule.equals("S")){
                    ...
                    Date dtSchedule = StringTasks.cleanDate(pa.getDtSchedule());
    ...
    private void sendMail(ProgramaAvisos oPA,Date dtSchedule,String hrSchedule,String oidDealerSchedule) throws SCErrorException {
